...
namespace LeagueBot.Game.Entities
{
    public class ActivePlayer : ApiMember<GameApi>
    {
        ...
        public void upgradeSpell(int indice) // <---- replace this by keybinding + league settings
        {
            ...
            switch (indice)
            {
                ...
                case 4:
                    ...
                    break;
                default:
                    Globals.logger.Write("Unknown spell indice :" + indice, MessageState.WARNING);
                    return;
            }
        ...
        public void upgradeSpellOnLevelUp()
        {
            ...
            {
                case 1:
                    Globals.logger.Write("[Q] Level up!");
                    upgradeSpell(1); // Q 1

                    break;
                case 2:
                    Globals.logger.Write("[W] Level up!");
                    upgradeSpell(2); // W 1

                    break;
                case 3:
                    upgradeSpell(3); // E 1
                    Globals.logger.Write("[E] Level up!");
                    break;
                case 4:
                    upgradeSpell(1); // Q 2
                    Globals.logger.Write("[Q] Level up!");
                ...
                case 6:
                    upgradeSpell(4); // R 1
                    Globals.logger.Write("[R] Level up!");
                    break;
                case 7:
                    upgradeSpell(1); // Q 4
                    Globals.logger.Write("[Q] Level up!");
